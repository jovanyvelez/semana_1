...
<div class="navbar bg-white text-black border-b-2  border-blue-300 px-14 py-1 font-bold font-sans">
	...
	<a  class="hover:text-blue-600 text-xl" href="/carrito">
